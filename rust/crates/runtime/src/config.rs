...
pub struct RuntimeFeatureConfig {
    ...
    /// When true, [`ConversationRuntime`] augments the system prompt with a
    /// think-first directive and parses responses through [`crate::think_mode`].
    think_mode: bool,
}
...
impl RuntimeFeatureConfig {
    ...
    /// Enable or disable think-mode. When enabled, [`ConversationRuntime`]
    /// augments the system prompt with a think-first directive and parses
    /// assistant replies through [`crate::think_mode`].
    #[must_use]
    pub fn with_think_mode(mut self, think_mode: bool) -> Self {
        self.think_mode = think_mode;
        self
    }

    /// Returns `true` when think-mode is enabled.
    #[must_use]
    pub fn think_mode(&self) -> bool {
        self.think_mode
    }
